...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        logger.info(f"hossein: LlamaAttention -> forward 1 [{get_shard_spec(q)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 1 [{k.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 1 [{get_shard_spec(k)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 1 [{v.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 1 [{get_shard_spec(v)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 1 [{get_shard_spec(kv_cache[0])=}]")
        logger.info(f"hossein: LlamaAttention -> forward 1 [{get_shard_spec(kv_cache[1])=}]")
        ...
        logger.info(f"hossein: LlamaAttention -> forward 3 [{q.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 3 [{get_shard_spec(q)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 3 [{k.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 3 [{get_shard_spec(k)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 3 [{v.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 3 [{get_shard_spec(v)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 3 [{attn_output.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 3 [{get_shard_spec(kv_cache[0])=}]")
        logger.info(f"hossein: LlamaAttention -> forward 3 [{get_shard_spec(kv_cache[1])=}]")

        output, _ = self.o_proj(attn_output)
        logger.info(f"hossein: LlamaAttention -> forward 4 [{output.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{q.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{get_shard_spec(q)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{k.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{get_shard_spec(k)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{v.shape=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{get_shard_spec(v)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{get_shard_spec(output)=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{get_shard_spec(kv_cache[0])=}]")
        logger.info(f"hossein: LlamaAttention -> forward 4 [{get_shard_spec(kv_cache[1])=}]")
